...
FLT_IMG = BW_Filtering( IMG, 2, 1/69 );
% filtering of FT across columns.
FLT_IMG = BW_Filtering( FLT_IMG, 1, 1/55 );
FLT_IMG = HP_Filtering( FLT_IMG, 2, 1/690 );
FLT_IMG = HP_Filtering( FLT_IMG, 1, 1/550 );
...
[L_img,Labels] = SizeOfRegions( t_img, 1500, 2500 );
figure(3);
...
for k = 1:Labels
    ...
    if length( Row ) > 1500 && length( Row ) < 2500 
